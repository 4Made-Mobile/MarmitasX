                            ...
                            <div class="form-panel">
                                ...
                                <form class="form-horizontal style-form" method="POST" action="" autocomplete="off">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="<?php echo $busca->descricao; ?> " name="descricao" class="form-control" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Data entrada do ingrediente</label>
                                        <div class="col-sm-10">
                                            <input type="text" value="<?php echo $busca->data1; ?>" name="data1" class="form-control" placeholder="AAAA-MM-DD">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="<?php echo $busca->data2; ?> " name="data2" class="form-control" placeholder="AAAA-MM-DD">
                                        </div>
                                    </div>
